...
class SonoffMINIZB2GSsplit extends SonoffBase {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('MINI-ZB2GS-split init — subDeviceId:', subDeviceId, '-> endpoint', this.endpointId);
        ...
        if (endpoint) {
            endpoint.bind(CLUSTER.ON_OFF.NAME, new MINIZB2GSsplitOnOffBoundCluster(this));
...
class MINIZB2GSsplitOnOffBoundCluster extends BoundCluster {
    constructor(device) {
        super();
        this.device = device;
    }
...
module.exports = SonoffMINIZB2GSsplit;
